...
function Comment(props) {
	...
	const updateComment = async () => {
		...
		await axios.patch(`http://43.201.255.244:8989/board/${boardId}/comment/update/${commentId}`, req, {headers: headers})
		.then((resp) => {
	...
	const deleteComment = async () => {
		await axios.delete(`http://43.201.255.244:8989/board/${boardId}}/comment/delete/${commentId}`, {headers: headers})
			.then((resp) => {
